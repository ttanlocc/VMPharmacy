...
import { Search, Plus, ArrowLeft, Loader2, Check, Phone, Edit3 } from 'lucide-react';
...
export default function CustomerSelectPage() {
    ...
    // OPTIMIZED: Navigate directly to checkout with customerId
    const handleSelect = (customer: any) => {
        router.push(`/checkout?customerId=${customer.id}`);
    };
